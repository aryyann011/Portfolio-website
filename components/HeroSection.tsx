...
export function Herosection(){
    return (
        <div className="relative flex flex-col justify-center items-start gap-2 dark:text-white">
            {/* <div className='flex justify-center'>
                <p className='text-3xl'>Hola</p>
            </div> */}
            <div className='flex justify-center items-start gap-9'>
                <div className="flex justify-start pt-16 text-xl text-gray-300 max-w-xl">
                    <div>
                        <Greeting/><br />
