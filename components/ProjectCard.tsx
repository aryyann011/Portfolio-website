...
export function ProjectCard({
  ...
  return (
    ...
    >
      <div className="relative h-64 overflow-hidden bg-zinc-100 dark:bg-gradient-to-br dark:from-zinc-800 dark:to-zinc-900">
        {image ? (
          <img
            src={image}
            alt={title}
          ...
          <div className="w-full h-full bg-zinc-100 dark:bg-gradient-to-br dark:from-zinc-700/40 dark:to-zinc-900/80 flex items-center justify-center">
            <span className="text-6xl font-bold text-zinc-300 dark:text-white/5 select-none">
              {title[0]}
            </span>
          </div>
        )}
      ...
      <div className="p-5 flex flex-col gap-3">
        <h3 className="text-zinc-900 dark:text-white font-semibold text-lg leading-tight">
          {title}
        </h3>
...
export function ProjectsSection() {
  return (
    <div className="w-full">
      <p className="text-zinc-900 dark:text-white text-2xl font-semibold font-satisfy mb-6">
        Projects
      </p>
